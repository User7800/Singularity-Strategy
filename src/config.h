...
#ifdef DEFAULT_THEME
	//#define ASSETS_FOLDER				"/home/martini/Projects/Singularity-Strategy/src/assets/default"
	// FIXME: This ASSETS_FOLDER seems to work based on the cwd when the exectuable is called.
	#define ASSETS_FOLDER				"src/assets/default"
